...
resource "azurerm_resource_group" "msk-stage-cosmosdb-resource-group" {
...
resource "azurerm_cosmosdb_account" "msk-stage-cosmosdb-database-account" {
  ...
  location            = azurerm_resource_group.msk-stage-cosmosdb-resource-group.location
  resource_group_name = azurerm_resource_group.msk-stage-cosmosdb-resource-group.name
...
output "cosmosdb_account_endpoint" {
  value = azurerm_cosmosdb_account.msk-stage-cosmosdb-database-account.primary_key
  sensitive = true
}
