...
data "azurerm_cosmosdb_account" "msk-stage-cosmosdb-database-account" {
  name                = var.msk-stage-cosmosdb-configurations["cosmosdb-name"]
  resource_group_name = var.msk-stage-cosmosdb-configurations["resource_group_name"]
}
...
locals {
  cosmosdb_primary_connection_string   = "AccountEndpoint=${data.azurerm_cosmosdb_account.msk-stage-cosmosdb-database-account.endpoint};AccountKey=${data.azurerm_cosmosdb_account.msk-stage-cosmosdb-database-account.primary_key};"
  cosmosdb_secondary_connection_string = "AccountEndpoint=${data.azurerm_cosmosdb_account.msk-stage-cosmosdb-database-account.endpoint};AccountKey=${data.azurerm_cosmosdb_account.msk-stage-cosmosdb-database-account.secondary_key};"
}

resource "azurerm_key_vault_secret" "msk-stage-cosmosdb-primary-connection" {
...
resource "azurerm_key_vault_secret" "msk-stage-cosmosdb-secondary-connection" {
